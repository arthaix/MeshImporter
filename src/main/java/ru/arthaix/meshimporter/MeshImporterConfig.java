...
public final class MeshImporterConfig {
    ...
    public static int webTriangles = 100_000;
    ...
    public static void load(File file) {
        ...
        webTriangles = cfg.getInt("webTriangles", "server", webTriangles, 1000, 5_000_000, "Most triangles of one model in the web map export");
